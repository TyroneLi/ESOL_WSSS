# Official Implementation of “Expansion and Shrinkage of Localization for Weakly-Supervised Semantic Segmentation” (NeurIPS 2022)

<p align="left"><img src="imgs/intro2.png" alt="outline" width="95%"></p>

> [Expansion and Shrinkage of Localization for Weakly-Supervised Semantic Segmentation (ESOL_WSSS)](http://arxiv.org/abs/2209.07761/) <br>
> [Jinlong Li](https://tyroneli.github.io), Zequn Jie, Xu Wang, Xiaolin Wei, [Lin Ma](https://forestlinma.com). <br>
> :star: NeurIPS 2022 (Spotlight)
